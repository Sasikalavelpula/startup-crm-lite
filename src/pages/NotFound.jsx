...
const NotFound = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center items-center px-4 font-roboto transition-colors duration-200">
      <div className="max-w-md w-full text-center space-y-8 p-8 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl relative overflow-hidden transition-colors duration-200">
        ...
        <div className="relative space-y-4">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-red-50 dark:bg-red-950/20 text-red-500 mb-2 border border-red-100 dark:border-red-900/50">
